...
function validarStep(step, form) {
  ...
  if (step === 3) {
    ...
    if (redesInvalidas)
      erros.redesSociais =
        "Preencha a plataforma e o link de todas as redes adicionadas.";
  }
...
function Cadastro() {
  ...
  function handleFotoChange(e) {
    ...
    if (arquivo) {
      ...
      if (!tipos.includes(arquivo.type)) {
        setErroGlobal("Use JPEG, PNG ou WebP.");
        return;
      }
      if (arquivo.size > 5 * 1024 * 1024) {
        setErroGlobal("Imagem máx. 5 MB.");
        return;
      }
    }
    setErroGlobal("");
  ...
  function avancar() {
    ...
    setStepsOk((prev) =>
      prev.includes(stepAtual) ? prev : [...prev, stepAtual],
    );
    setErros({});
  ...
  function voltar() {
    ...
    const pularArtistico =
      stepAnterior === 1 && form.tipo_usuario !== "artista";
    setErros({});
    setStepAtual(pularArtistico ? stepAnterior - 1 : stepAnterior);
  }

  function irParaStep(i) {
    if (stepsOk.includes(i)) {
      setErros({});
      setStepAtual(i);
    }
  }
  ...
  async function handleSubmit(e) {
    ...
    if (form.data_nasc.includes("/")) {
      ...
      if (!dia || !mes || !ano) {
        setErroGlobal("Data de nascimento inválida.");
        return;
      }
  ...
  return (
    <div className="cadastro-sonara-container">
      <header className="header-cadastro">
        <img className="header-cadastro__logo" src={logo} alt="Logo Sonara" />
        ...
        >
          ...
          <div className="cadastro-stepper" role="list">
            {stepsVisiveis.map((label, vi) => {
              const realIdx =
                form.tipo_usuario === "artista" ? vi : vi >= 1 ? vi + 1 : vi;
            ...
            <div className="cadastro-step-painel">
              ...
              <div className="cadastro-sonara-grid">
                <div className={classCampo("nome")}>
                  ...
                  />
                  {erros.nome && (
                    <span className="campo-mensagem-erro">{erros.nome}</span>
                  )}
                </div>
                ...
                <div className={classCampo("cpf")}>
                  ...
                  />
                  {erros.cpf && (
                    <span className="campo-mensagem-erro">{erros.cpf}</span>
                  )}
                </div>
                ...
                <div className={classCampo("data_nasc")}>
                  ...
                  />
                  {erros.data_nasc && (
                    <span className="campo-mensagem-erro">
                      {erros.data_nasc}
                    </span>
                  )}
                </div>
              ...
              <p
                className="cadastro-sonara-secao-titulo"
              ...
              <div className="cadastro-sonara-grid">
                <div className={classCampo("email")}>
                  ...
                  />
                  {erros.email && (
                    <span className="campo-mensagem-erro">{erros.email}</span>
                  )}
                </div>
              ...
              <div className="cadastro-sonara-grid">
                <div className={classCampo("senha")}>
                  ...
                  />
                  {erros.senha && (
                    <span className="campo-mensagem-erro">{erros.senha}</span>
                  )}
                </div>
                  ...
                  <div className="select-wrapper">
                    ...
                    >
                      ...
                      {nacionalidades.map((n) => (
                        <option
                          key={n.id_nacionalidade}
                          value={n.id_nacionalidade}
                        >
                          {n.nome}
                        </option>
                      ))}
              ...
              <div className="cadastro-sonara-grid cadastro-sonara-grid--full">
                <div className="cadastro-sonara-campo">
                  <label htmlFor="foto">
                    Foto de perfil (opcional, máx. 5 MB)
                  </label>
                  <input
                    type="file"
                    id="foto"
          ...
          {stepAtual === 1 && form.tipo_usuario === "artista" && (
            <div className="cadastro-step-painel">
              <p className="cadastro-sonara-secao-titulo">
              ...
              <div className="cadastro-sonara-grid cadastro-sonara-grid--full">
                <div
                  className={
                    erros.generos_musicais
                      ? "cadastro-sonara-campo campo--erro"
                      : "cadastro-sonara-campo"
                  }
                >
          ...
          {stepAtual === 2 && (
            <div className="cadastro-step-painel">
              ...
              <div className="cadastro-sonara-grid">
                <div
                  className={`cadastro-sonara-campo${statusCep === "erro" ? " campo--erro" : statusCep === "ok" ? " campo--ok" : ""}`}
                >
                  ...
                  {msgCep && (
                    <span
                      className={`cep-hint cep-hint--${buscandoCep ? "buscando" : statusCep}`}
                    >
                      {msgCep}
                    </span>
                  )}
                  {erros.cep && (
                    <span className="campo-mensagem-erro">{erros.cep}</span>
                  )}
                </div>

                <div
                  className={classCampo("logradouro")}
              ...
              <div className="cadastro-sonara-grid">
                <div className={classCampo("numero")}>
                  ...
                  />
                  {erros.numero && (
                    <span className="campo-mensagem-erro">{erros.numero}</span>
                  )}
                </div>
                ...
                <div className={classCampo("bairro")}>
                  ...
                  />
                  {erros.bairro && (
                    <span className="campo-mensagem-erro">{erros.bairro}</span>
                  )}
                </div>
              </div>
              ...
              <div className="cadastro-sonara-grid cadastro-sonara-grid--2">
                <div className={classCampo("cidade")}>
                  ...
                  />
                  {erros.cidade && (
                    <span className="campo-mensagem-erro">{erros.cidade}</span>
                  )}
                </div>
                ...
                <div className={classCampo("estado")}>
                  ...
                  />
                  {erros.estado && (
                    <span className="campo-mensagem-erro">{erros.estado}</span>
                  )}
                </div>
              </div>
            </div>
          ...
          {stepAtual === 3 && (
            <div className="cadastro-step-painel">
              ...
              <button
                type="button"
                className="btn-inline-secundario"
          ...
          {/* ── Mensagens globais ── */}
          {erroGlobal && (
            <div role="alert" className="msg-feedback msg-feedback--erro">
              {erroGlobal}
            </div>
          )}
          {sucesso && (
